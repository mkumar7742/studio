...
import { X, PenSquare, BookText, CircleDollarSign, BedDouble, PlaneTakeoff, PlaneLanding, CalendarIcon } from "lucide-react";
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-screen bg-background text-foreground p-6 md:p-8">
                ...
                <div className="flex-1 overflow-y-auto space-y-8 pr-2">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-base font-semibold uppercase tracking-wider text-muted-foreground">TRIP DETAILS</h2>
                        ...
                        <h2 className="text-base font-semibold uppercase tracking-wider text-muted-foreground">ITINERARY</h2>
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-col gap-2">
                                        <FormLabel className="flex items-center gap-2"><PlaneTakeoff className="size-4" /> Departure Date*</FormLabel>
                                        <Popover>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                     <FormItem className="flex flex-col gap-2">
                                        <FormLabel className="flex items-center gap-2"><PlaneLanding className="size-4" /> Return Date*</FormLabel>
                                        <Popover>
                                            <PopoverTrigger asChild>
                                                <FormControl>
                                                    <Button variant={"outline"} className={cn("w-full pl-3 text-left font-normal bg-card border-border", !field.value && "text-muted-foreground")}>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-base font-semibold uppercase tracking-wider text-muted-foreground">BUDGET & ACCOMMODATION</h2>
                        <div className="space-y-6 grid grid-cols-1 md:grid-cols-[auto_1fr] gap-x-4 gap-y-6 items-center">
